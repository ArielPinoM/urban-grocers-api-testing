## BR-35
POST ```/order-and-go/v1/delivery``` returns 200 OK when sending a request with the data type object in the "productsCount" field.
...
### Visual Evidence
![Visual Evidence](../screenshots/br-35.png)