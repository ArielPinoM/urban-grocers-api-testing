## BR-38
POST ```/order-and-go/v1/delivery``` returns 200 OK when sending a request with the data type boolean in the "productsWeight" field.
...
### Visual Evidence
![Visual Evidence](../screenshots/br-38.png)