## BR-37
POST ```/order-and-go/v1/delivery``` returns 200 OK when sending a request with the data type string in the "productsWeight" field.
...
### Visual Evidence
![Visual Evidence](../screenshots/br-37.png)