## BR-34
POST ```/order-and-go/v1/delivery``` returns 200 OK when sending a request with the data type null in the "productsCount" field.
...
### Visual Evidence
![Visual Evidence](../screenshots/br-34.png)