## BR-18
POST ```/api/v1/kits/:id/products``` returns 500 Internal Server Error when "id" is valid and "quantity" is a boolean value in the request body while adding products to a kit.
...
2. Send a request using the "TestKit" id in Path Variables, id = 1 and quantity = true in the request body.
...
### Visual Evidence
![Visual Evidence](../screenshots/br-18.png)