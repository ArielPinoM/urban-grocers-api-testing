## BR-15
POST ```/api/v1/kits/:id/products``` returns 200 OK when "id" is valid and "quantity" is null in the request body while adding products to a kit.
...
2. Send a request using the "TestKit" id in Path Variables, id = 1 and quantity = null in the request body.
...
### Visual Evidence
![Visual Evidence](../screenshots/br-15.png)