## BR-36
POST ```/order-and-go/v1/delivery``` returns 200 OK when sending a request with the data type array in the "productsCount" field.
...
### Visual Evidence
![Visual Evidence](../screenshots/br-36.png)