## BR-32
POST ```/order-and-go/v1/delivery``` returns 200 OK when sending a request with the data type floating-point number in the "productsCount" field.
...
### Visual Evidence
![Visual Evidence](../screenshots/br-32.png)