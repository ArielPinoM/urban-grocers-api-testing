## BR-27
POST ```/order-and-go/v1/delivery``` returns 200 OK when sending a request with the data type floating-point in the "deliveryTime" field.
...
### Visual Evidence
![Visual Evidence](../screenshots/br-27.png)